...
- [ ] Stat block detection (system-aware)
...
- [ ] Monster/NPC extraction to structured format
- [ ] Random table extraction to rollable format
- [ ] Spell extraction
- [ ] Export to Foundry VTT format
- [ ] Export to Obsidian markdown
- [ ] Campaign management (link products to campaigns)
