...
| Task | Description | Status |
|------|-------------|--------|
| RunNote model | Store GM notes about running products | TODO |
| Note types | prep_tip, modification, warning, review | TODO |
| Spoiler tagging | none, minor, major, endgame | TODO |
| Run notes UI in Grimoire | Add/edit notes on products | TODO |
| Share to Codex | Contribute notes to community | TODO |
| Privacy controls | Private / Anonymous / Public | TODO |
